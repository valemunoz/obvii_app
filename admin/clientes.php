...
<br>
	...
	<table id=table_filtro>
	 ...
	 <td>
			...
			<tr>
				<td>
	            		<img src="img/add.png" class=mano onclick="nuevoCliente();" title="Nuevo Usuario">
	            	</td>
			...
			<td><input type="button" onclick="filtrar_cli();" value="Filtrar"></td>
		</tr>	
	</table>
