...
<div class="ch-container">
    ...
    <ul class="breadcrumb">
        ...
        <li>
            <a href="us_buscar.php">Busqueda de Usuarios</a>
        </li>
    </ul>
</div>
...
<div class="row" id="filtro_user">
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select data-rel="chosen" id="em_estado" name="em_estado">
                 ...
                 <div class="control-group">
                 	...
                 	<div class="controls">
                 <select data-rel="chosen" id="lug_us" name="lug_us">				
                ...
                <div class="input-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="nom_fil" name=nom_fil>
                </div>
                <div class="input-group col-md-4">
                ...
                <br>
                <div class="input-group col-md-4">
                	<button type="submit" class="btn btn-default" onclick="filtrar_usInterno();">Filtrar</button>
  ...
  <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="box-inner">
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Resultados</h2>
