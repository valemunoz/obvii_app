...
if(substr(strtolower($data_server[0]),0,strlen(PATH_SITE_WEB))==PATH_SITE_WEB)
{
    ...
    <tr>
    	<td><?=$us[0]?></td>
        <td><?=ucwords($us[1])?></td>
        <td class="center"><?=ucwords($detalle_lugar[0][1])?></td>
        
       
        <td class="center">
        	<a class="btn btn-info" href="javascript:loadUsuarioInt('<?=encrypt($us[0],ENCRIPTACION)?>');">
                ...
                Editar
						...
						if($us[2]==0)
						{
							...
							<a class="btn btn-danger" href="javascript:upUsuarioEstInt(1,'<?=encrypt($us[0],ENCRIPTACION)?>');">
                ...
                Bajar
						...
						}else
						{
							...
							?>
							<a class="btn btn-success" href="javascript:upUsuarioEstInt(0,'<?=encrypt($us[0],ENCRIPTACION)?>');">
